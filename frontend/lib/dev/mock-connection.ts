...
function buildDevResponse(input: string, model: ModelId): string {
  ...
  const modelName = { 'claude-haiku': 'Claude Haiku', 'claude-opus': 'Claude Opus', 'claude-sonnet': 'Claude Sonnet', 'grok': 'Grok 4', 'grok-build': 'Grok Build 0.1', 'grok-multi': 'Grok 4.20 Multi', 'gemini-flash': 'Gemini 3.1' }[model] ?? model;
